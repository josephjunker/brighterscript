 ...
 */
export type GetArgumentsToPotentiallyOptionalFunctions<T> = {
...
export default class PluginInterface<T extends CompilerPlugin = CompilerPlugin> {
     ...
     */
    public emit<K extends keyof GetArgumentsToPotentiallyOptionalFunctions<T> & string>(event: K, ...args: GetArgumentsToPotentiallyOptionalFunctions<T>[K]) {
